...
```shell
claude plugin marketplace add https://github.com/antgroup/adversarial-ai-coding-plugin.git
```

**3. 安装插件**

```shell
claude plugin install adversarial-ai-coding
```
...
```shell
claude plugin marketplace update adversarial-ai-coding-plugin
```
